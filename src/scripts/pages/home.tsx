...
import { BoxWidgetComponent } from '../components/box-widget'
import { ChartComponent } from '../components/chart'
import { SparklinesComponent } from '../components/sparklines'
import { VectorMapComponent } from '../components/vector-map'
...
export function PagesHomeComponent (attrs, children) {
  return (state, actions) => (
    <div>
      ...
      <section class="content">
        ...
        <div class="row">
          <div class="col-md-8">
            <BoxWidgetComponent class="box-success">
              <div class="box-header with-border">
            ...
            <div class="row">
              <div class="col-md-6">
                <BoxWidgetComponent class="box-warning direct-chat direct-chat-warning">
                  <div class="box-header with-border">
              ...
              <div class="col-md-6">
                <BoxWidgetComponent class="box-danger">
                  <div class="box-header with-border">
                  ...
                  <div class="box-body no-padding">
                    <ul class="users-list clearfix">
                      <li>
                        <img src={images.user1_128x128} alt="User Image" />
                      ...
                      <li>
                        <img src={images.user8_128x128} alt="User Image" />
                        <a class="users-list-name" href="#">
                          Norman
                        </a>
                      ...
                      <li>
                        <img src={images.user7_128x128} alt="User Image" />
                        <a class="users-list-name" href="#">
                          Jane
                        </a>
                      ...
                      <li>
                        <img src={images.user6_128x128} alt="User Image" />
                        <a class="users-list-name" href="#">
                          John
                        </a>
                        <span class="users-list-date">12 Jan</span>
                      ...
                      <li>
                        <img src={images.user2_160x160} alt="User Image" />
                        <a class="users-list-name" href="#">
                          Alexander
                        </a>
                      ...
                      <li>
                        <img src={images.user5_128x128} alt="User Image" />
                        <a class="users-list-name" href="#">
                          Sarah
                        </a>
                      ...
                      <li>
                        <img src={images.user4_128x128} alt="User Image" />
                        <a class="users-list-name" href="#">
                          Nora
                        </a>
                      ...
                      <li>
                        <img src={images.user3_128x128} alt="User Image" />
                        <a class="users-list-name" href="#">
                          Nadia
                        </a>
                        <span class="users-list-date">15 Jan</span>
            ...
            <BoxWidgetComponent class="box-info">
              <div class="box-header with-border">
          ...
          <div class="col-md-4">
            ...
            <BoxWidgetComponent class="box-default">
              <div class="box-header with-border">
            ...
            <BoxWidgetComponent class="box-primary">
              <div class="box-header with-border">
                ...
                <ul class="products-list product-list-in-box">
                  <li class="item">
                    <div class="product-img">
                      <img src={images.default_50x50} alt="Product Image" />
                    </div>
